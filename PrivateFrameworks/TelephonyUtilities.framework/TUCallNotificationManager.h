...
- (void)postNotificationsForCall:(id)arg1 comparedToCall:(id)arg2;
- (void)postNotificationsForCall:(id)arg1 comparedToCall:(id)arg2 afterUpdatesInBlock:(id /* block */)arg3;
