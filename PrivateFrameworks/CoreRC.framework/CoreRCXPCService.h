...
- (void)_fakeCreateRemoteCECDeviceAsync:(unsigned long long)arg1 bus:(id)arg2 logicalAddress:(unsigned char)arg3 physicalAddress:(unsigned long long)arg4 reply:(id /* block */)arg5;
...
- (void)_performDeckControlCommandAsync:(id)arg1 controlMode:(unsigned long long)arg2 targetDevice:(id)arg3 hasEntitlement:(id)arg4 reply:(id /* block */)arg5;
- (void)_performDeckControlPlayAsync:(id)arg1 playMode:(unsigned long long)arg2 targetDevice:(id)arg3 hasEntitlement:(id)arg4 reply:(id /* block */)arg5;
- (void)_performDeckControlRefreshStatusAsync:(id)arg1 targetDevice:(id)arg2 requestType:(unsigned long long)arg3 hasEntitlement:(id)arg4 reply:(id /* block */)arg5;
- (void)_performDeckControlSetDeckStatusAsync:(unsigned long long)arg1 forDevice:(id)arg2 hasEntitlement:(id)arg3 reply:(id /* block */)arg4;
...
- (void)_performSetPowerStatus:(unsigned long long)arg1 withDeviceAsync:(id)arg2 hasEntitlement:(id)arg3 reply:(id /* block */)arg4;
...
- (void)_performSystemAudioModeRequestAsync:(id)arg1 withDesiredState:(unsigned long long)arg2 hasEntitlement:(id)arg3 reply:(id /* block */)arg4;
- (void)_queryBusesAsync:(id /* block */)arg1;
- (void)_queryLocalInstanceAsync:(unsigned long long)arg1 bus:(id)arg2 client:(id)arg3 reply:(id /* block */)arg4;
...
- (void)fakeCreateRemoteCECDeviceAsync:(unsigned long long)arg1 bus:(id)arg2 logicalAddress:(unsigned char)arg3 physicalAddress:(unsigned long long)arg4 reply:(id /* block */)arg5;
...
- (void)queryLocalInstanceAsync:(unsigned long long)arg1 bus:(id)arg2 reply:(id /* block */)arg3;
