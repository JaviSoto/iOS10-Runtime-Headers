...
@interface CoreIRLearningSessionProvider : CoreIRLearningSession {
    ...
    NSObject<OS_dispatch_source> * _captureProgressTimer;
    ...
    NSMutableDictionary * _learnedMapping;
...
- (void)duplicateIRCommand:(id)arg1;
- (void)endLearning;
...
- (long)initTimers;
- (id)mappings;
- (unsigned int)processCapturedPattern;
