...
+ (id)animationStepWithDelay:(double)arg1 duration:(double)arg2 options:(unsigned long long)arg3 block:(id /* block */)arg4;
...
- (double)duration;
- (id)init;
- (id)initWithDelay:(double)arg1 duration:(double)arg2 options:(unsigned long long)arg3 block:(id /* block */)arg4;
