...
@interface HMDHome : NSObject <HMDAccessoryManagerDelegate, HMDRelayManagerDelegate, HMMessageReceiver, NSSecureCoding> {
...
@property (nonatomic) BOOL cloudRelayEnabled;
...
- (void)_addAllUsersToAccessories:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_addUser:(id)arg1 toAccessories:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_addUser:(id)arg1 toAccessory:(id)arg2 completionQueue:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)_addUser:(id)arg1 userPrivilege:(unsigned int)arg2 confirm:(BOOL)arg3 message:(id)arg4;
- (id)_administrator;
- (void)_appendCharacteristicsToAccessoryList:(id)arg1 responseTuples:(id)arg2 forMultipleCharacteristicsRemoteRead:(id)arg3;
- (void)_appendCharacteristicsToAccessoryList:(id)arg1 responseTuples:(id)arg2 forMultipleCharacteristicsRemoteWrite:(id)arg3;
...
- (void)_configureUnconfiguredResident:(id)arg1 desiredConfigState:(unsigned int)arg2 message:(id)arg3;
...
- (void)_handleEnableCloudRelay:(id)arg1;
...
- (void)_handleUpdateResidentConfigurationState:(id)arg1;
...
- (void)_postInternalNotificationForChangedCharacterisitics:(id)arg1;
- (void)_postInternalNotificationForChangedCharacterisitics:(id)arg1 changedByThisDevice:(BOOL)arg2;
...
- (void)_processAnyPendingOutgoingInvitations;
...
- (void)_removeOutgoingInvitationMatchingUserID:(id)arg1;
- (void)_removeService:(id)arg1;
- (void)_removeUser:(id)arg1 fromAccessory:(id)arg2 ignoreFailure:(BOOL)arg3 completionQueue:(id)arg4 completionHandler:(id /* block */)arg5;
...
- (void)mergeOutgoingInvitations:(id)arg1 dataVersion:(int)arg2;
- (BOOL)mergeUsersWithExistingUsers:(id)arg1;
