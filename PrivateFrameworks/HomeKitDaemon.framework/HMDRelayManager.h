...
- (BOOL)isEnabled;
- (BOOL)isSupported;
- (void)pairWithRelayAccessories:(id)arg1;
- (id)propertyQueue;
- (id)relayAccessories;
- (id)relayStreams;
- (void)removeDelegate:(id)arg1;
- (void)removeRelayAccessory:(id)arg1;
- (void)removeUser:(id)arg1 fromRelayAccessory:(id)arg2 completionQueue:(id)arg3 completionHandler:(id /* block */)arg4;
