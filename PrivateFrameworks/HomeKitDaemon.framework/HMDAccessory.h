...
@property (nonatomic, retain) NSMutableArray *transportInformationInstances;
...
- (unsigned int)_currentRelayAccessoryState;
- (void)_enableNotification:(BOOL)arg1 hapAccessory:(id)arg2 unconditionallyDeregister:(BOOL)arg3 ignoreDeviceUnlockRequirement:(BOOL)arg4 clientIdentifier:(id)arg5 forCharacteristics:(id)arg6;
- (void)_enableNotificationForCharacteristic:(id)arg1 hapAccessory:(id)arg2 message:(id)arg3;
...
- (void)setTransportInformationInstances:(id)arg1;
