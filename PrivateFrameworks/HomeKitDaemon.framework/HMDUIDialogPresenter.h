...
- (BOOL)_presentDialogWithInfo:(id)arg1 options:(unsigned long)arg2 textField:(id*)arg3 withContext:(id)arg4 selectedByPeerDevice:(BOOL*)arg5 timeout:(double)arg6;
...
- (void)confirmReportAccessory:(id)arg1 home:(id)arg2 context:(id)arg3 completionQueue:(id)arg4 completionHandler:(id /* block */)arg5;
- (id)currentContext;
