...
- (void)_addPairingForRemoteAccessPoint:(id)arg1 destination:(id)arg2 controllerInfo:(id)arg3 forHome:(id)arg4 completionHandler:(id /* block */)arg5;
- (void)_addPendingDataSyncAcksForUser:(id)arg1 forHome:(id)arg2;
- (void)_addWatch:(id)arg1;
- (void)_addWatch:(id)arg1 toAssociatedList:(id)arg2;
- (void)_autoAddUser:(id)arg1 destination:(id)arg2 forHome:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_configureResidentForRemoteAccess:(id)arg1 forHome:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)_createIdentifierSalt:(id)arg1;
...
- (id)_prepareDataForDevicesOnSameAccountForHome:(id)arg1;
...
- (void)_removeHome:(id)arg1 withMessage:(id)arg2 removedByLocalUser:(BOOL)arg3;
...
- (id)_tunneledAccessories:(id)arg1;
...
- (void)configureResidentForRemoteAccess:(id)arg1 forHome:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)dataTag;
- (void)dealloc;
...
- (void)setIncomingInvitesPresent:(BOOL)arg1;
