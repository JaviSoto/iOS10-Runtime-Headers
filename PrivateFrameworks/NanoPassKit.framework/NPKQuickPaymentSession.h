...
- (void)_deactivateSessionWithCompletion:(id /* block */)arg1;
- (void)_handleCurrentPassPreferredPaymentApplicationChanged:(id)arg1;
...
- (BOOL)_sessionQueue_updateContactlessSessionForPass:(id)arg1 paymentApplication:(id)arg2 allVASPasses:(id)arg3;
- (id)callbackQueue;
