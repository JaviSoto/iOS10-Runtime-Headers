...
@interface PRSBagHandler : NSObject <CLLocationManagerDelegate, PRSParsecDataHandler, PRSResourceProvider, PRSSessionController> {
    ...
    double  _geoUserSessionEntitySessionStartTime;
...
@property (readonly) int cep_dynamic_rank;
...
@property (readonly) int cep_sort_of_tophits;
@property (readonly) int cep_top_hit_threshold;
...
@property double geoUserSessionEntitySessionStartTime;
...
- (void)_generateInstalledApplicationsSignature;
...
- (id)assertion;
- (int)cep_dynamic_rank;
- (int)cep_probability_factor;
- (id)cep_qi_ratios;
- (id)cep_server_values;
- (int)cep_sort_of_tophits;
- (int)cep_top_hit_threshold;
- (id)client;
- (id)collectedData;
- (id)connectionType;
- (id)dataTask;
...
- (double)geoUserSessionEntitySessionStartTime;
...
- (void)setGeoUserSessionEntitySessionStartTime:(double)arg1;
