...
+ (id)_createQueryURL:(id)arg1 userQueryString:(id)arg2 keyboardLanguage:(id)arg3 currentLocation:(id)arg4 locationSource:(id)arg5 currentCoordinates:(struct { double x1; double x2; })arg6 storeFrontId:(id)arg7 locale:(id)arg8 context:(id)arg9 routineLocation:(id)arg10 userAgent:(id)arg11 queryLanguage:(id)arg12;
+ (id)_createURLRequestWithString:(id)arg1 keyboardLanguage:(id)arg2 webSearch:(BOOL)arg3 scaleFactor:(float)arg4 allowLocation:(BOOL)arg5 fallbackURL:(id*)arg6 urlSessionConfiguration:(id)arg7 cachedQueries:(id)arg8 cachedResults:(id)arg9 userAgent:(id)arg10 queryLanguage:(id)arg11;
+ (id)_urlRequestFromURL:(id)arg1 urlSessionConfiguration:(id)arg2;
+ (id)currentLocation;
...
- (id)createFeedbackRequest:(id*)arg1 allowUserId:(BOOL)arg2;
- (id)createQueryURL:(id)arg1 userQueryString:(id)arg2 keyboardLanguage:(id)arg3 currentLocation:(id)arg4 locationSource:(id)arg5 currentCoordinates:(struct { double x1; double x2; })arg6 storeFrontId:(id)arg7 locale:(id)arg8 context:(id)arg9 routineLocation:(id)arg10;
