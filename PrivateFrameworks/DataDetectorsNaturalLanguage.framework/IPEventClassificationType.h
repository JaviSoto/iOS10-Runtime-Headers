...
@property (nonatomic, retain) NSRegularExpression *eventsRegex;
...
@property (nonatomic, retain) NSRegularExpression *keywordsRegex;
...
@property (nonatomic, retain) IPEventClassificationType *parent;
@property (getter=isSportRelated, nonatomic, readonly) bool sportRelated;
@property (retain) NSString *subjectKeywordsPattern;
@property (retain) NSRegularExpression *subjectKeywordsRegex;
...
- (void)setEventsRegex:(id)arg1;
- (void)setHighPriority:(bool)arg1;
- (void)setIdentifier:(id)arg1;
- (void)setKeywords:(id)arg1;
- (void)setKeywordsRegex:(id)arg1;
