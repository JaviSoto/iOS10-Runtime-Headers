...
- (void).cxx_destruct;
- (void)_refreshToken:(id)arg1 appContainerTuple:(id)arg2 apsEnvironmentString:(id)arg3 usesAPSPublicToken:(long long)arg4 darkWakeEnabled:(bool)arg5 isCKSystemService:(bool)arg6 completionBlock:(id /* block */)arg7;
- (void)_removeToken:(id)arg1 appContainerTuple:(id)arg2 apsEnvironmentString:(id)arg3 usesAPSPublicToken:(long long)arg4 darkWakeEnabled:(bool)arg5 isCKSystemService:(bool)arg6 completionBlock:(id /* block */)arg7;
- (id)callbackBlocks;
- (id)callbackTimers;
