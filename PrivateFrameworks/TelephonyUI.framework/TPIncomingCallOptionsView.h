...
@class TPBottomBar<TPBottomGrabberBar>, UITableView, NSMutableArray, UIView, TPBottomGrabberLockBar, NSObject<TPIncomingCallOptionsViewDelegate>, TPBottomBar, NSArray;
