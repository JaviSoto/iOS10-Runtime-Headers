...
- (id)_initializeDatabase:(id)arg1 withProtection:(BOOL)arg2;
...
- (BOOL)addSpotlightReferenceToEmail:(id)arg1 withBundleIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 domainIdentifier:(id)arg4;
...
- (void)pruneEntitiesOlderThan:(double)arg1;
...
- (void)writeIdentityBlobs:(id)arg1;
