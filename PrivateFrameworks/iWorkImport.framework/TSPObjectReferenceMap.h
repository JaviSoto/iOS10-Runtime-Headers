...
- (unsigned long long)visitObjectWithIdentifier:(long long)arg1 level:(unsigned long long)arg2 mode:(int)arg3 limit:(unsigned long long)arg4 pathSuffix:(id)arg5 context:(id)arg6 delegate:(id)arg7 visitedObjectIdentifiers:(id)arg8 updatingParentObjectPaths:(id)arg9;
