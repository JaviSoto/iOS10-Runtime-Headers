...
- (id)p_infosForSlide;
- (void)p_initializeTextureSetForRep:(id)arg1 info:(id)arg2 eventIndex:(unsigned long long)arg3 shouldPrepareBuildAnimation:(bool)arg4 ignoreBuildVisibility:(bool)arg5 isRenderingToContext:(bool)arg6 buildInfos:(id)arg7 postInitBlock:(id /* block */)arg8;
...
- (void)preloadTexturesForEvent:(unsigned long long)arg1 ignoreBuildVisibility:(bool)arg2 priority:(long long)arg3 completionHandler:(id /* block */)arg4;
