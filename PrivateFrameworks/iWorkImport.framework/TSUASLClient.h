...
- (void)_populateAslmsg:(struct __asl_object_s { }*)arg1 category:(id)arg2 object:(id)arg3 documentPath:(id)arg4 function:(const char *)arg5 source:(const char *)arg6 line:(long long)arg7;
...
- (void)logWithLevel:(int)arg1 category:(id)arg2 object:(id)arg3 documentPath:(id)arg4 function:(const char *)arg5 source:(const char *)arg6 line:(long long)arg7 message:(id)arg8;
