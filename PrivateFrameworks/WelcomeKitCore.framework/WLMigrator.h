...
- (double)_progressIncrementForAccountAndSummaryWithMigrator:(id)arg1;
- (double)_progressIncrementForDownloadedSummary:(id)arg1 summaries:(id)arg2 accounts:(id)arg3 migrator:(id)arg4;
