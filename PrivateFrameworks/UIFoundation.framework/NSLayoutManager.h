...
@class NSTextContainer, NSGlyphGenerator, NSTypesetter, NSStorage, NSMutableArray, NSTextStorage, UIView<NSTextContainerView>, UIFont, <NSLayoutManagerDelegate>, NSRunStorage, NSArray;
