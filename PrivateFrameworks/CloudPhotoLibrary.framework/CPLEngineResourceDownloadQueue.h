...
- (id)_downloadTaskForLocalResource:(id)arg1 clientBundleID:(id)arg2 highPriority:(bool)arg3 background:(bool)arg4 backgroundTaskIdentifier:(unsigned long long)arg5 proposedTaskIdentifier:(id)arg6 didStartHandler:(id /* block */)arg7 progressHandler:(id /* block */)arg8 completionHandler:(id /* block */)arg9;
...
- (id)dequeueBackgroundDownloadTaskForResourceType:(unsigned long long)arg1 withCompletionHandler:(id /* block */)arg2;
- (id)dequeueBackgroundDownloadTasks:(unsigned long long)arg1 forResourceType:(unsigned long long)arg2 eachWithCompletionHandler:(id /* block */)arg3;
