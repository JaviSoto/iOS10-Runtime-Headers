...
+ (void)fireModalTimeToLeaveFeedbackForAlertInfo:(id)arg1;
+ (void)maybePresentTimeToLeaveFeedbackForAlertInfo:(id)arg1 delayed:(bool)arg2;
+ (double)requestHypothesisRefreshInterval;
+ (void)submitTTLFeedback:(unsigned long long)arg1 forAlertInfo:(id)arg2;
+ (id)timeToLeaveFeedbackURLforAlertInfo:(id)arg1;
...
- (id)_dateTimeStringComponentsForEvent:(id)arg1;
...
- (id)_ttlFeedbackSurveySubsection;
