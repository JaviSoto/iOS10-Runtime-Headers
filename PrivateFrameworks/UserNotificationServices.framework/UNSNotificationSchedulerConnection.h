...
- (void)_queue_didSnoozeLocalNotifications:(id)arg1 forBundleIdentifier:(id)arg2;
- (void)_queue_ensureConnection;
- (void)_queue_interruptedConnection;
- (void)_queue_invalidatedConnection;
- (void)_queue_removeObserver:(id)arg1 forBundleIdentifier:(id)arg2;
- (void)_queue_scheduledLocalNotificationsDidChangeForBundleIdentifier:(id)arg1;
