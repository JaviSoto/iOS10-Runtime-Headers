...
@property (nonatomic, readonly) double pad;
...
- (void)_updateDepartureAndArrivalSuggestions:(id)arg1 arrivalDate:(id)arg2 travelTimeWithTraffic:(double)arg3 transportType:(int)arg4;
