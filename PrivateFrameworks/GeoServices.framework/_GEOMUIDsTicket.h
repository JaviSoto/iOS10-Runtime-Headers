...
- (id)description;
- (id)init;
- (id)initWithMUIDs:(id)arg1 resultProviderID:(int)arg2 contentProviderID:(id)arg3 includeETA:(BOOL)arg4 traits:(id)arg5;
- (id)initWithMUIDs:(id)arg1 resultProviderID:(int)arg2 contentProviderID:(id)arg3 includeETA:(BOOL)arg4 traits:(id)arg5 options:(unsigned int)arg6;
- (BOOL)isCanceled;
