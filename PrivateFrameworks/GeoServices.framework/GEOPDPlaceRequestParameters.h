...
@class GEOPDLocationDirectedSearchParameters, GEOPDCanonicalLocationSearchParameters, GEOPDGeocodingParameters, GEOPDPlaceRefinementParameters, GEOPDReverseGeocodingParameters, GEOPDSearchParameters, GEOPDSiriSearchParameters, GEOPDPlaceLookupParameters, GEOPDMerchantLookupParameters;
