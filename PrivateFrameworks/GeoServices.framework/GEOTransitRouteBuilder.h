...
- (void)_buildPointSectionsForRoute:(id)arg1 pointRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg2 stepIndex:(unsigned int)arg3;
...
- (id)_sectionForRoute:(id)arg1 pointRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg2 stepIndex:(unsigned int)arg3 bounds:(struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg4;
