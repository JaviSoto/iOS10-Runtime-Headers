...
- (id)_geoMapItemForUpdatedPlaceInDetails:(id)arg1;
...
- (id)ticketForFreshComponents:(id)arg1 muid:(unsigned long long)arg2 resultProviderID:(int)arg3 contentProviderID:(id)arg4 traits:(id)arg5;
- (id)ticketForFreshMUIDs:(id)arg1 resultProviderID:(int)arg2 contentProviderID:(id)arg3 includeETA:(BOOL)arg4 traits:(id)arg5;
...
- (id)ticketForMUIDs:(id)arg1 resultProviderID:(int)arg2 contentProviderID:(id)arg3 includeETA:(BOOL)arg4 traits:(id)arg5;
...
- (id)ticketForURLQuery:(id)arg1 coordinate:(struct { double x1; double x2; })arg2 muid:(unsigned long long)arg3 resultProviderId:(int)arg4 contentProviderId:(id)arg5 maxResults:(unsigned int)arg6 traits:(id)arg7;
