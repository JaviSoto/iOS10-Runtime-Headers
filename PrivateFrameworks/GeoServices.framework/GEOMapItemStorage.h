...
@class NSURL, GEOMapItemPhotosAttribution, GEOMapItemPlaceAttribution, GEOPDFlyover, NSDictionary, GEOMapRegion, GEOFeatureStyleAttributes, NSString, GEOMapItemReviewsAttribution, GEOPlace, GEOPDPlace, NSArray, NSData, GEOAddress, GEOMapItemClientAttributes;
