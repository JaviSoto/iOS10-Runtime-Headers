...
@class GEOPDPlace, GEOAddress, NSString, GEOMapItemClientAttributes, GEOPlace, NSArray, NSDictionary, NSData, GEOPDFlyover, NSURL, GEOMapRegion;
...
+ (id)mapItemStorageForPlace:(id)arg1 routineAttributes:(id)arg2;
