...
@property (nonatomic, readonly, copy) NSArray *coverArticleFeedItems;
...
@property (nonatomic, readonly, copy) NSArray *supplementalCoverArticleFeedItems;
...
- (id)supplementalCoverArticleFeedItems;
