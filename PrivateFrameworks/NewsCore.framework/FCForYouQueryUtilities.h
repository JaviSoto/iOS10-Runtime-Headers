...
+ (id)feedRequestsForTags:(id)arg1 tagBinProvider:(id /* block */)arg2 hiddenFeedIDs:(id)arg3 purchasedTagIDs:(id)arg4 contentContext:(id)arg5 maxCount:(unsigned long long)arg6 tagIDFeedRangeProvider:(id /* block */)arg7;
