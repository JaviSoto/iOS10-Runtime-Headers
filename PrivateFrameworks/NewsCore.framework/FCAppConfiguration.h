...
- (void)_fetchAppConfigurationForStoreFrontID:(id)arg1 cachePolicy:(unsigned long long)arg2 refreshRate:(double)arg3 completionQueue:(id)arg4 completion:(id /* block */)arg5;
- (void)_fetchTrendingSearchesForStoreFrontID:(id)arg1 cachePolicy:(unsigned long long)arg2 completionQueue:(id)arg3 completion:(id /* block */)arg4;
