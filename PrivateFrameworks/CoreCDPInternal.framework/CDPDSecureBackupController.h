...
- (void)_authenticatedEnableSecureBackupWithSecret:(id)arg1 secretType:(unsigned long long)arg2 useCachedSecret:(bool)arg3 completion:(id /* block */)arg4;
...
- (void)_enableSecureBackupWithSecret:(id)arg1 secretType:(unsigned long long)arg2 useCachedSecret:(bool)arg3 completion:(id /* block */)arg4;
...
- (void)enableSecureBackupRemovingExistingRecordWithSecret:(id)arg1 secretType:(unsigned long long)arg2 useCachedSecret:(bool)arg3 completion:(id /* block */)arg4;
- (void)enableSecureBackupWithSecret:(id)arg1 secretType:(unsigned long long)arg2 useCachedSecret:(bool)arg3 completion:(id /* block */)arg4;
