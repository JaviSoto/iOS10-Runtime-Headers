...
@interface PSUIPrefsListController : PSListController <DevicePINControllerDelegate, HMHomeManagerDelegatePrivate, PSSearchControllerDelegate, RadiosPreferencesDelegate> {
