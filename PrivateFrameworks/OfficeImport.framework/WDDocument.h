...
@class OADBackground, WDListDefinitionTable, WDCitationTable, WDStyleSheet, NSDate, OADTheme, WDFontTable, WDListTable, WDRevisionAuthorTable, WDText, NSMutableSet, NSString, NSMutableArray;
