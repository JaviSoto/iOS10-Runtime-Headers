...
- (void)startDownloadingDirectory:(id)arg1 usingRemoteFileManager:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)startDownloadingFile:(id)arg1 usingRemoteFileManager:(id)arg2 completionHandler:(id /* block */)arg3;
