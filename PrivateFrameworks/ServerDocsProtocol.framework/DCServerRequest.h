...
- (id)startBothloadTaskWithURI:(id)arg1 service:(id)arg2 headers:(id)arg3 body:(id)arg4 responseHandler:(id /* block */)arg5;
- (id)startDownloadTaskWithURI:(id)arg1 service:(id)arg2 headers:(id)arg3 body:(id)arg4 responseHandler:(id /* block */)arg5;
