...
- (id)initWithDisplayType:(unsigned long long)arg1 handler:(id /* block */)arg2;
- (id)initWithDisplayType:(unsigned long long)arg1 qualityOfService:(unsigned long long)arg2 handler:(id /* block */)arg3;
- (void)invalidate;
