...
@class MFSearchShadowView, UIPopoverController, NSArray, PLComposeRecipientView, NSString, UITableView, MFContactsSearchManager, <PLComposeRecipientViewControllerDelegate>, MFContactsSearchResultsModel, NSNumber, UIScrollView;
