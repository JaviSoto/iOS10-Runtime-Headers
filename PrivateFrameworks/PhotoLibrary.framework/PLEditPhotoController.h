...
@class NSDictionary, PLImageAdjustmentView, CIContext, NSMutableArray, NSTimer, UIAlertView, PLManagedAsset, CIFilter, NSUndoManager, UIPopoverController, NSMutableDictionary, UILabel, UIToolbar, UINavigationBar, EAGLContext, NSObject<OS_dispatch_queue>, UIScrollView, NSArray, UIImage, PLEffectSelectionViewController, PLProgressHUD, UIView, UIActionSheet;
