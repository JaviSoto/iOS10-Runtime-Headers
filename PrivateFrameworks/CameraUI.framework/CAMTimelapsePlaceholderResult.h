...
- (id)init;
- (id)initWithAssetUUID:(id)arg1 creationDate:(id)arg2 captureOrientation:(int)arg3 usingFrontCamera:(BOOL)arg4 videoDimensions:(struct CGSize { float x1; float x2; })arg5 previewImageSurface:(void*)arg6;
