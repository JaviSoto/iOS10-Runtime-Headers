...
@interface CAMCaptureEngine : NSObject <CAMPanoramaProcessorDelegate> {
    unsigned int  __attemptedRecoveryCount;
    ...
    NSMutableArray * __effectsPreviewSampleBufferDelegates;
    ...
    AVCaptureStillImageOutput2 * _stillImageOutput;
...
@property (setter=_setAttemptedRecoveryCount:, nonatomic) unsigned int _attemptedRecoveryCount;
...
@property (nonatomic, readonly) NSMutableArray *_effectsPreviewSampleBufferDelegates;
...
- (unsigned int)_attemptedRecoveryCount;
...
- (void)_notifyServicesOfPanoramaConfigurationChange;
...
- (void)_setAttemptedRecoveryCount:(unsigned int)arg1;
...
- (void)_updatePanoramaSubgraphForEnteringBackground:(BOOL)arg1;
