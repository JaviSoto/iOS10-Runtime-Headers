...
@interface CAMViewfinderViewController : UIViewController <CAMAvailabilityDelegate, CAMBurstDelegate, CAMCallStatusMonitorDelegate, CAMCameraRollControllerPresentationDelegate, CAMCameraRollControllerSessionDelegate, CAMCaptureInterruptionDelegate, CAMCaptureRecoveryDelegate, CAMCaptureRunningDelegate, CAMClosedViewfinderControllerDelegate, CAMConfigurationDelegate, CAMControlVisibilityDelegate, CAMEffectsRendererDelegate, CAMFacesDelegate, CAMModeDialDataSource, CAMPanoramaCaptureRequestDelegate, CAMPreviewViewControllerDelegate, CAMRemoteShutterDelegate, CAMStillImageCaptureRequestDelegate, CAMSuggestionDelegate, CAMTimelapseControllerDelegate, CAMTimerButtonDelegate, CAMVideoCaptureRequestDelegate, CAMZoomDelegate, CAMZoomSliderDelegate, UIGestureRecognizerDelegate> {
    ...
    int  __primaryConflictingControl;
...
@property (setter=_setPrimaryConflictingControl:, nonatomic) int _primaryConflictingControl;
...
- (void)_notifyCameraRollDidPersistAssetWithUUID:(id)arg1;
...
- (void)_rotateTopBarAndControlsToOrientation:(int)arg1;
...
- (void)_setEffectFilterType:(int)arg1 forMode:(int)arg2;
...
- (void)_setPrimaryConflictingControl:(int)arg1;
...
- (void)_updateCurrentFlashHDRAndStillImageModes;
...
- (void)callStatusMonitor:(id)arg1 didChangeCallActive:(BOOL)arg2;
...
- (id)initWithCaptureController:(id)arg1 captureConfiguration:(id)arg2 conflictingControlConfiguration:(id)arg3 locationController:(id)arg4 motionController:(id)arg5 timelapseController:(id)arg6 keepAliveController:(id)arg7 remoteShutterController:(id)arg8;
...
- (void)timelapseController:(id)arg1 didCreatePlaceholderAssetWithResult:(id)arg2;
