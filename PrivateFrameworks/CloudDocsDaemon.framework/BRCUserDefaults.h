...
@property (nonatomic, readonly) unsigned int minAutomaticallyEvictableFilesize;
@property (nonatomic, readonly) unsigned int minEvictableFilesize;
@property (nonatomic, readonly) unsigned long long minFileSizeForThumbnailTransfer;
@property (nonatomic, readonly) unsigned long long minimalSizeToShowAdditionalDescription;
...
- (unsigned int)minAutomaticallyEvictableFilesize;
- (unsigned int)minEvictableFilesize;
- (unsigned long long)minFileSizeForThumbnailTransfer;
- (unsigned long long)minimalSizeToShowAdditionalDescription;
