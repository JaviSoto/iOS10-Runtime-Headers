...
@class SKUIWishlist, NSString, _UIContentUnavailableView, _UIBackdropView, SKUISyncWishlistOperation, SKUIItemListTableViewController, UIBarButtonItem, <SKUIWishlistDelegate>;
