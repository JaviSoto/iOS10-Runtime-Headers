...
@class MSAlbumSharingDaemon, NSObject<OS_dispatch_queue>, NSCountedSet, MSASStateMachine, MSASServerSideModelGroupedCommandQueue, MSASPendingChanges, NSString;
