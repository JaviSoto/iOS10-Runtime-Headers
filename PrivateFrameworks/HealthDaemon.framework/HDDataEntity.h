...
+ (id)databaseTable;
+ (BOOL)deleteDataObjects:(id)arg1 restrictedSourceEntity:(id)arg2 failIfNotFound:(BOOL)arg3 healthDaemon:(id)arg4 error:(id*)arg5;
...
+ (id)insertDataObject:(id)arg1 withProvenance:(id)arg2 creationDate:(id)arg3 healthDaemon:(id)arg4 error:(id*)arg5;
+ (id)insertDataObject:(id)arg1 withProvenance:(id)arg2 inDatabase:(id)arg3 persistentID:(id)arg4 error:(id*)arg5;
+ (void)insertDataObjects:(id)arg1 withProvenance:(id)arg2 creationDate:(id)arg3 healthDaemon:(id)arg4 completionHandler:(id /* block */)arg5;
+ (BOOL)isBackedByTable;
+ (id)joinClausesForProperty:(id)arg1;
+ (BOOL)journalObjects:(id)arg1 withProvenance:(id)arg2 creationDate:(id)arg3 healthDaemon:(id)arg4 error:(id*)arg5;
