...
- (void).cxx_destruct;
- (unsigned long long)_addConnectedPeripheral:(id)arg1 forService:(id)arg2 withSessionHandler:(id /* block */)arg3 withTransitoryHandler:(id /* block */)arg4 withCharacteristicsHandler:(id /* block */)arg5;
...
- (unsigned long long)connectHealthService:(id)arg1 healthDatabase:(id)arg2 sessionHandler:(id /* block */)arg3 error:(id*)arg4;
- (unsigned long long)connectHealthService:(id)arg1 healthDatabase:(id)arg2 sessionHandler:(id /* block */)arg3 transitoryHandler:(id /* block */)arg4 characteristicsHandler:(id /* block */)arg5 error:(id*)arg6;
...
- (unsigned long long)discoverHealthServicesWithType:(long long)arg1 timeout:(unsigned long long)arg2 handler:(id /* block */)arg3 error:(id*)arg4;
