...
- (BOOL)insertDataObjects:(id)arg1 sourceEntity:(id)arg2 deviceEntity:(id)arg3 sourceVersion:(id)arg4 creationDate:(id)arg5 error:(id*)arg6;
- (BOOL)insertDataObjects:(id)arg1 withProvenance:(id)arg2 creationDate:(id)arg3 error:(id*)arg4;
