...
@interface HDActiveWorkoutServer : NSObject <HDDataObserver, HDDatabaseProtectedDataObserver, HKWorkoutSessionDelegate, _HKActiveWorkoutServer> {
...
@property (nonatomic, retain) NSNumber *currentAnchor;
...
- (void)_observerQueue_updateTotalsWithEnergyBurned:(double)arg1 distance:(double)arg2 UUIDs:(id)arg3 inJournal:(BOOL)arg4;
