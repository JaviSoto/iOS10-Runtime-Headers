...
- (void)_createRecordZonesWithIDs:(id)arg1 priority:(long long)arg2 completion:(id /* block */)arg3;
- (void)_fetchChangesInDatabase:(id)arg1 serverChangeTokenCache:(id)arg2 priority:(long long)arg3 completion:(id /* block */)arg4;
...
- (void)_saveRecordsIntoPrivateDatabase:(id)arg1 savePolicy:(long long)arg2 priority:(long long)arg3 completion:(id /* block */)arg4;
- (void)_saveRecordsIntoPrivateDatabaseCreatingZones:(id)arg1 savePolicy:(long long)arg2 priority:(long long)arg3 completion:(id /* block */)arg4;
...
- (void)fetchChangesInPrivateDatabaseWithServerChangeTokenCache:(id)arg1 priority:(long long)arg2 completion:(id /* block */)arg3;
- (void)fetchChangesInSharedDatabaseWithServerChangeTokenCache:(id)arg1 priority:(long long)arg2 completion:(id /* block */)arg3;
