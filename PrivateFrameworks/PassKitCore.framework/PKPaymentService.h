...
- (void)contactlessInterfaceDidDismissForPassWithUniqueIdentifier:(id)arg1 fromSource:(int)arg2;
- (void)contactlessInterfaceDidPresentForPassWithUniqueIdentifier:(id)arg1 fromSource:(int)arg2;
- (void)dealloc;
...
- (void)paymentDeviceDidEnterFieldWithProperties:(id)arg1 forPassUniqueIdentifiers:(id)arg2;
