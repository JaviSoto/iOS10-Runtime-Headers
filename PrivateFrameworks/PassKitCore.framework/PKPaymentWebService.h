...
- (unsigned int)rewrapInAppPayment:(id)arg1 merchantIdentifier:(id)arg2 hostBundleIdentifier:(id)arg3 applicationData:(id)arg4 pass:(id)arg5 completion:(id /* block */)arg6;
