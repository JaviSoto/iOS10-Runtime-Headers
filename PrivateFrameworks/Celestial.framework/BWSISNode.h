...
- (id)_initWithCameraTuningDictionary:(id)arg1 sensorIDDictionary:(id)arg2 pbAndJ:(int)arg3 allowExperimentalOverrides:(BOOL)arg4;
...
- (id)initWithCameraTuningDictionary:(id)arg1 sensorIDDictionary:(id)arg2 pbAndJ:(int)arg3;
