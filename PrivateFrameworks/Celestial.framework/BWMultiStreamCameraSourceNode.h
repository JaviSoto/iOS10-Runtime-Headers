...
@interface BWMultiStreamCameraSourceNode : BWSourceNode <BWFigCameraSourceNode> {
    ...
    BOOL  _discardsAllFramesWithVideoOption5;
    NSMutableDictionary * _dutyCycleMetadataCache;
    struct opaqueCMSimpleQueue { } * _feature0BQ;
    struct { 
        int width; 
        int height; 
    }  _feature0Dimensions;
    BOOL  _feature0Enabled;
    struct opaqueCMFormatDescription { } * _feature0FD;
    ...
    struct OpaqueFigSampleBufferProcessor { } * _usesFeature0SBP;
...
- (long)_setupFeature0Processor;
- (long)_setupForFeature0;
...
- (BOOL)discardsAllFramesWithVideoOption5;
- (struct { int x1; int x2; })feature0Dimensions;
...
- (void)setDiscardsAllFramesWithVideoOption5:(BOOL)arg1;
- (void)setFeature0Dimensions:(struct { int x1; int x2; })arg1;
