...
- (void)fileWriter:(id)arg1 stoppedRecordingForSettings:(id)arg2 withError:(long)arg3 thumbnailSurface:(struct __IOSurface { }*)arg4 movieInfo:(id)arg5 recordingSucceeded:(BOOL)arg6;
