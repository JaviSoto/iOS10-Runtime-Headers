...
@interface HAPAccessoryServerRelay : HAPAccessoryServer <HAPFragmentationStreamDelegate, HAPSecuritySessionDelegate, HAPStreamDelegate> {
    ...
    unsigned char  _nextRequestSequence;
...
@property (nonatomic, readonly) unsigned char nextRequestSequence;
...
- (void)_handleFragmentedResponse:(id)arg1 sequenceNumber:(unsigned char)arg2 error:(id)arg3;
...
- (void)fragmentationStream:(id)arg1 didReceiveData:(id)arg2 sequenceNumber:(unsigned char)arg3 error:(id)arg4;
- (BOOL)hasPairings;
...
- (int)linkType;
- (unsigned char)nextRequestSequence;
