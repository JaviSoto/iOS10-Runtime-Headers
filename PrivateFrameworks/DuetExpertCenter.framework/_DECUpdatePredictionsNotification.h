...
- (void)dealloc;
- (id)init;
- (void)registerForNotificationsForPredictionCategory:(unsigned long long)arg1 andConsumerType:(unsigned long long)arg2 withCachedDateGetter:(id /* block */)arg3 andUpdateBlock:(id /* block */)arg4 finallyBlock:(id /* block */)arg5;
