...
- (id)queue;
- (void)receiveAppWidgetFeedback:(id)arg1 consumerType:(unsigned long long)arg2 reply:(id /* block */)arg3;
...
- (void)receiveZkwSpotlightFeedback:(id)arg1 consumerType:(unsigned long long)arg2 reply:(id /* block */)arg3;
