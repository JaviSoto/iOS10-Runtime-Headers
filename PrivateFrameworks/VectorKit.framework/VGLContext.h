...
@class VGLSharegroup, VGLResourceFactory, VGLVertexArrayObject, EAGLContext, VGLGPU, VGLTexture, NSMapTable, VGLFramebuffer, VGLProgram, NSString, VGLMesh, NSMutableArray, VGLProgramFactory;
