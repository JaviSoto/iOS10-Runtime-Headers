...
+ (id)_bundleIDVersionsWithProperties:(id)arg1;
...
- (void)_replacePurgeableDataRepresentationWithData:(id)arg1;
- (void)_updateCachedValuesWithProperties:(id)arg1;
- (id)accessPurgeableDataRepresentation;
...
- (void)endAccessPurgeableDataRepresentation:(id)arg1;
- (id)exportedTypes;
