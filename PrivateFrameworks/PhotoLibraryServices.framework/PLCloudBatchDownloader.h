...
- (void)_handleAssetRecords:(id)arg1 inLibrary:(id)arg2 withChangeBatch:(id)arg3 hasResourceChange:(bool*)arg4;
- (void)_handleDeleteRecords:(id)arg1 inLibrary:(id)arg2;
- (void)_handleExpungedRecords:(id)arg1 inLibrary:(id)arg2;
- (void)_handleMasterRecords:(id)arg1 inLibrary:(id)arg2 hasResourceChange:(bool*)arg3;
...
- (void)handleIncomingBatch:(id)arg1 outHasResourceChanges:(bool*)arg2;
