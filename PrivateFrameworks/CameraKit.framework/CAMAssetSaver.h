...
- (void)queueJobDictionary:(id)arg1 asset:(id)arg2 filters:(id)arg3 requestEnqueuedBlock:(id)arg4 completionBlock:(id)arg5 imageSurface:(void*)arg6 previewImageSurface:(void*)arg7 transient:(bool)arg8;
