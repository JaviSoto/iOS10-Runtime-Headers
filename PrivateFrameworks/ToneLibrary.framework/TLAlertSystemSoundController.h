...
- (void)_didCompletePlaybackForAlert:(id)arg1 completionHandler:(id /* block */)arg2 playbackCompletionType:(long long)arg3 error:(id)arg4;
...
- (void)_stopPlayingAlerts:(id)arg1 withOptions:(struct { double x1; })arg2 playbackCompletionType:(long long)arg3 completionHandler:(id /* block */)arg4;
- (void)_stopRepeatedlyPlayingAlert:(id)arg1 withOptions:(unsigned long long)arg2 completionHandler:(id /* block */)arg3 targetQueue:(id)arg4;
...
- (void)stopPlayingAlerts:(id)arg1 withOptions:(struct { double x1; })arg2 playbackCompletionType:(long long)arg3 completionHandler:(id /* block */)arg4;
- (void)stopRepeatedlyPlayingAlert:(id)arg1 withOptions:(unsigned long long)arg2 completionHandler:(id /* block */)arg3 targetQueue:(id)arg4;
