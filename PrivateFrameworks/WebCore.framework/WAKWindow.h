...
@interface WAKWindow : WAKResponder  {
  ...
  /* Unexpected information at end of encoded ivar type: {Vector<WebCore::IntRect, 0, WTF::CrashOnOverflow>=^{IntRect}II}fff{Mutex={_opaque_pthread_mutex_t=q[56c]}}{Mutex={_opaque_pthread_mutex_t=q[56c]}}{Mutex={_opaque_pthread_mutex_t=q[56c]}}B} */
  /* Error parsing encoded ivar type info: ^{LegacyTileCache=@{RetainPtr<CGImage *>=^v}BBB{RetainPtr<LegacyTileCacheTombstone>=^v}ii{IntSize=ii}BBBBBB{OwnPtr<WebCore::LegacyTileGrid>=^{LegacyTileGrid}}{OwnPtr<WebCore::LegacyTileGrid>=^{LegacyTileGrid}}{Timer<WebCore::LegacyTileCache>=^^?dddiI^{Vector<WebCore::TimerBase *, 0, WTF::CrashOnOverflow>}{function<void ()>={type=[24C]}^{__base<void ()>}}}{Vector<WebCore::IntRect, 0, WTF::CrashOnOverflow>=^{IntRect}II}fff{Mutex={_opaque_pthread_mutex_t=q[56c]}}{Mutex={_opaque_pthread_mutex_t=q[56c]}}{Mutex={_opaque_pthread_mutex_t=q[56c]}}B} */
