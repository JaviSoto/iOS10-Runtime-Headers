...
@class MFMailMessageLibraryMigrator, NSObject<OS_dispatch_queue>, MFDbJournal, <MFMailMessageLibraryDelegate>, <MFMailboxPathProvider>, MFSQLiteConnectionPool, MFAttachmentLibraryDataProvider, MFLibraryContentIndex, NSString, MFWeakObjectCache, NSMutableSet;
