...
- (bool)presentationCoordinator:(HUQuickControlPresentationCoordinator *)arg1 shouldBeginPresentationWithTouchLocation:(struct CGPoint { double x1; double x2; })arg2;
