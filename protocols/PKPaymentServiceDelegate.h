...
- (void)contactlessInterfaceDidDismissForPassWithUniqueIdentifier:(NSString *)arg1 fromSource:(int)arg2;
- (void)contactlessInterfaceDidPresentForPassWithUniqueIdentifier:(NSString *)arg1 fromSource:(int)arg2;
...
- (void)paymentDeviceDidEnterFieldWithProperties:(PKFieldProperties *)arg1 forPassUniqueIdentifiers:(NSArray *)arg2;
