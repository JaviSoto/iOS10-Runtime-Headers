...
- (TSKSearch *)searchForString:(void *)arg1 options:(void *)arg2 searchCanvasDelegate:(void *)arg3 onHit:(void *)arg4; // needs 4 arg types, found 9: NSString *, unsigned long long, <TSKSearchCanvasDelegate> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <TSKSearchReference> *, void*
