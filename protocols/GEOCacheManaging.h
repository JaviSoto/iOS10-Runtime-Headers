...
- (void)refreshLOIAssociatedMapItems:(void *)arg1 updatedCoordinates:(void *)arg2 handler:(void *)arg3; // needs 3 arg types, found 9: NSArray *, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, NSError *, void*
- (void)refreshLOIReverseGeocodedMapItems:(void *)arg1 updatedCoordinates:(void *)arg2 handler:(void *)arg3; // needs 3 arg types, found 9: NSArray *, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, NSError *, void*
