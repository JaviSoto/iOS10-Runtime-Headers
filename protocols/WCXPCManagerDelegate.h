...
- (void)xpcManager:(WCXPCManager *)arg1 handUserInfoTransfer:(WCSessionUserInfoTransfer *)arg2;
...
- (void)xpcManager:(WCXPCManager *)arg1 handleSessionStateChanged:(WCSessionState *)arg2;
