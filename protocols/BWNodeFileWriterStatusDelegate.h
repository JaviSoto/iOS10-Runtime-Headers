...
- (void)fileWriter:(BWFileSinkNode *)arg1 stoppedRecordingForSettings:(FigCaptureRecordingSettings *)arg2 withError:(long)arg3 thumbnailSurface:(struct __IOSurface { }*)arg4 movieInfo:(BWMovieInfo *)arg5 recordingSucceeded:(BOOL)arg6;
