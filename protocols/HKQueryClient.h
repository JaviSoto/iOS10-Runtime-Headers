...
- (void)deliverSampleBatch:(NSArray *)arg1 deletedBatch:(NSArray *)arg2 final:(BOOL)arg3 anchor:(NSNumber *)arg4 forQuery:(NSUUID *)arg5;
...
- (void)deliverResultsResetWithAnchor:(NSNumber *)arg1 final:(BOOL)arg2 forQuery:(NSUUID *)arg3;
- (void)deliverSample:(HKSample *)arg1 forQuery:(NSUUID *)arg2;
- (void)deliverSampleObjects:(NSArray *)arg1 deletedObjects:(NSArray *)arg2 withAnchor:(NSNumber *)arg3 forQuery:(NSUUID *)arg4;
