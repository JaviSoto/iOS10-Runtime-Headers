...
@class NSMutableDictionary, <PKPassGroupStackViewDatasource>, PKReusablePassViewQueue, NSMutableArray, PKPassPaymentFooterView, <PKPassGroupStackViewDelegate><UIScrollViewDelegate>, NSString, NSTimer, PKPassGroupView, NSArray, PKPass, PKGroup, PKPaymentService;
