...
@class UIImageView, PKUsageNotificationServer, NSMutableArray, UIButton, PKPaymentWelcomeView, UIScrollView, <PKPassGroupsViewControllerDelegate>, NSString, NSTimer, PKLegacyWelcomeView, PKPaymentService, PKPassGroupStackView, PKGroupsController, PKPassWelcomeView;
