...
@interface CNContactContentViewController : UITableViewController <ABContactViewDataSource, ABContactViewDelegate, CNContactActionDelegate, CNContactContentViewController, CNContactContentViewControllerDelegate, CNContactGroupPickerDelegate, CNContactHeaderViewDelegate, CNPresenterDelegate, CNPropertyActionDelegate, CNPropertyCellDelegate, CNPropertyGroupItemDelegate, CNQuickActionsViewDelegate, UIAdaptivePresentationControllerDelegate, UIPopoverControllerDelegate, UIViewControllerRestoration> {
    ...
    BOOL  _alwaysEditing;
    int  _animating;
    NSArray * _barButtonItemsAddedForEditing;
    NSArray * _barButtonItemsStack;
...
@property (nonatomic, copy) NSArray *barButtonItemsAddedForEditing;
@property (nonatomic, copy) NSArray *barButtonItemsStack;
...
- (id)barButtonItemsAddedForEditing;
- (id)barButtonItemsStack;
- (id)blockAction;
...
- (void)setBarButtonItemsAddedForEditing:(id)arg1;
- (void)setBarButtonItemsStack:(id)arg1;
