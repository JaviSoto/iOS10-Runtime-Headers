...
@class UIView, SLSheetTitleView, NSArray, SLComposeServiceViewController, UITableViewController, UINavigationItem, UIImage, UITableView, NSString, UIViewController;
