...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, UINavigationBarDelegate, GKContentRefresh, GKURLHandling> {
    ...
    bool_condensesBarsWhenKeyboardAppears;
    bool_condensesBarsOnSwipe;
...
@property bool condensesBarsWhenKeyboardAppears;
@property bool condensesBarsOnSwipe;
@property(retain,readonly) UIPanGestureRecognizer * barCondenseGestureRecognizer;
@property bool hidesBarsWhenVerticallyCompact;
@property bool hidesBarsOnTap;
@property(readonly) UITapGestureRecognizer * barHideGestureRecognizer;
...
@property(setter=_setKeyboardCondenseNotificationToken:,retain) id _keyboardCondenseNotificationToken;
@property(setter=_setBarCondenseGesture:,retain) _UIBarPanGestureRecognizer * _barCondenseGesture;
@property(setter=_setBarCondenseAnimationCoordinator:,retain) _UIAnimationCoordinator * _barCondenseAnimationCoordinator;
@property(setter=_setBarHideGesture:,retain) _UIBarTapGestureRecognizer * _barHideGesture;
...
- (long long)_builtinTransitionStyle;
- (id)_barHideGesture;
- (id)_barCondenseGesture;
- (id)_keyboardCondenseNotificationToken;
...
- (bool)condensesBarsWhenKeyboardAppears;
- (Class)_toolbarClass;
- (void)setNavigationBarCondensed:(bool)arg1;
- (id)barHideGestureRecognizer;
- (id)barCondenseGestureRecognizer;
...
- (bool)isNavigationBarCondensed;
- (id)_barCondenseAnimationCoordinator;
- (void)_gestureRecognizedCondense:(id)arg1;
- (void)_makeBarCondenseGestureIfNecessary;
- (void)_setBarsCondensed:(bool)arg1;
...
- (void)_setBarHideGesture:(id)arg1;
- (void)_setBarCondenseAnimationCoordinator:(id)arg1;
- (void)_setBarCondenseGesture:(id)arg1;
- (void)_setKeyboardCondenseNotificationToken:(id)arg1;
- (void)setHidesBarsOnTap:(bool)arg1;
- (void)setHidesBarsWhenVerticallyCompact:(bool)arg1;
- (void)setCondensesBarsOnSwipe:(bool)arg1;
- (void)setCondensesBarsWhenKeyboardAppears:(bool)arg1;
