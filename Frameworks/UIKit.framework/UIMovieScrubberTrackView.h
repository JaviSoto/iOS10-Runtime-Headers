...
@class UIView, NSArray, <UIMovieScrubberTrackViewDataSource>, UIMovieScrubberTrackOverlayView, NSMutableDictionary, NSDictionary, <UIMovieScrubberTrackViewDelegate>;
