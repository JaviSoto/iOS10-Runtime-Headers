...
+ (struct CGContext { }*)imageContextWithSize:(struct CGSize { double x1; double x2; })arg1 scale:(double)arg2 usesRGBColor:(bool)arg3 opaque:(bool)arg4 invert:(bool)arg5;
...
- (void)setDisableRGBColor:(bool)arg1;
