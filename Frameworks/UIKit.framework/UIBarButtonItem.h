...
@interface UIBarButtonItem : UIBarItem <NSCoding> {
    ...
    NSArray * __popoverLayoutGuideConstraints;
...
@property (setter=_setPopoverLayoutGuideConstraints:, nonatomic, copy) NSArray *_popoverLayoutGuideConstraints;
...
- (id)_popoverLayoutGuideConstraints;
...
- (void)_setPopoverLayoutGuideConstraints:(id)arg1;
