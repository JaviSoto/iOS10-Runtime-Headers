...
@class NSDictionary, UITextPosition, UITextInputTraits, UIView<UITextInputPrivate>, UITextChecker, UIView<UITextInput>, UITextRange, NSString, _UITextKitTextRange, NSArray, _UIDictationAttachment, _UITextUndoOperationTyping, _UITextServiceSession, UIView, <UITextInputControllerDelegate>, _UITextUndoManager, <UITextInputTokenizer>, _UITextInputControllerTokenizer, <UITextInputDelegate>, UIResponder<UITextInput>, NSLayoutManager, NSHashTable;
