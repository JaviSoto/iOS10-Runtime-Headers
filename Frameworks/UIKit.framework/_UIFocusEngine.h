...
@interface _UIFocusEngine : NSObject <UIGestureRecognizerDelegate> {
    ...
    unsigned int  _headingsScrollViewContentHasBeenLoadedFor;
...
- (struct CGPoint { float x1; float x2; })_contentOffsetForScrollView:(id)arg1 toFocusView:(id)arg2 directionHint:(struct CGVector { float x1; float x2; })arg3;
