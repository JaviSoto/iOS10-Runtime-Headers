...
@class DOMHTMLElement, UITapGestureRecognizer, DOMNode, NSDictionary, UIAutoscroll, UIPanGestureRecognizer, UITextRange, CALayer, DOMElement, _UIWebViewportHandler, _UIWebHighlightLongPressGestureRecognizer, WebHistoryItem, UIWebFileUploadPanel, UIColor, UILongPressGestureRecognizer, UIWebRotatingAlertController, WebThreadSafeUndoManager, UITextPosition, UITextInteractionAssistant, _UITextServiceSession, UIView, NSArray, NSString, <UITextInputDelegate>, UIWebPlaybackTargetPicker, UIWebSelectionAssistant, UITextChecker, NSTimer, UITextInputTraits, WebView, DOMRange, UIImage, <UITextInputTokenizer>;
