...
@interface UISplitViewController : UIViewController <GKContentRefresh, GKURLHandling, UIGestureRecognizerDelegate> {
    ...
    UIViewController * _lastFocusedChildViewController;
...
@property (getter=_lastFocusedChildViewController, nonatomic, readonly) UIViewController *lastFocusedChildViewController;
...
- (id)_lastFocusedChildViewController;
