...
@interface UICollectionViewLayoutInvalidationContext : NSObject {
    ...
    bool  _initiatedFromBoundsChange;
...
@property (getter=_initiatedFromBoundsChange, setter=_setInitiatedFromBoundsChange:, nonatomic) bool initiatedFromBoundsChange;
...
- (void)_setInitiatedFromBoundsChange:(bool)arg1;
