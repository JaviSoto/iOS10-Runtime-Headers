...
@class NSError, PFUbiquitySwitchboardEntry, PFUbiquityTransactionLog, NSManagedObjectContext, PFUbiquityKnowledgeVector, NSMutableDictionary, PFUbiquityImportContext, NSPersistentStoreCoordinator, NSMutableSet, NSObject<_PFUbiquityRecordImportOperationDelegate>, NSString;
