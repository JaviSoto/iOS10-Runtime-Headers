...
@interface SKFade : SKAction  {
  ...
  /* Error parsing encoded ivar type info: ^{SKCFade=^^?If@BddffdBB@?qfffffffB} */
    struct SKCFade { int (**x1)(); unsigned int x2; float x3; id x4; boolx5; double x6; double x7; float x8; float x9; double x10; boolx11; boolx12; id x13; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x14; long long x15; float x16; float x17; float x18; float x19; float x20; float x21; float x22; boolx23; } *_mycaction;
