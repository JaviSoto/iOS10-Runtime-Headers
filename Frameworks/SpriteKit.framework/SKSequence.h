...
@interface SKSequence : SKAction  {
  ...
  /* Error parsing encoded ivar type info: ^{SKCSequence=^^?f@BddffdBB@?iffff{vector<SKCAction *, std::__1::allocator<SKCAction *> >=^^{SKCAction}^^{SKCAction}{__compressed_pair<SKCAction **, std::__1::allocator<SKCAction *> >=^^{SKCAction}}}L} */
