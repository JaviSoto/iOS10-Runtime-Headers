...
- (void)_addUser:(id)arg1 privilege:(unsigned long long)arg2 confirmWithLocalUser:(bool)arg3 confirmWithRemoteUser:(bool)arg4 completionHandler:(id /* block */)arg5;
- (void)_addUser:(id)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)_addUserWithCompletionHandler:(id /* block */)arg1;
- (void)_addUserWithoutConfirmation:(id)arg1 privilege:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
...
- (void)addUserWithoutConfirmation:(id)arg1 privilege:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
