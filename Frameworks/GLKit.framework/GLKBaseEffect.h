...
@class GLKEffectPropertyTransform, NSString, NSArray, GLKEffectPropertyTexture, GLKEffectPropertyConstantColor, GLKEffectPropertyMaterial, GLKEffect, NSMutableArray, GLKEffectPropertyLight, GLKEffectPropertyFog;
