...
@interface RPYouTubeActivity : UIActivity <PLPublishingAgentDelegate> {
    NSString * _descriptionText;
    NSURL * _movieURL;
    RPYouTubeActivityProgressOverlay * _progressOverlay;
    PLPublishingAgent * _publishingAgent;
}

@property (nonatomic, retain) NSString *descriptionText;
@property (nonatomic, retain) NSURL *movieURL;
@property (nonatomic, retain) RPYouTubeActivityProgressOverlay *progressOverlay;
@property (nonatomic, retain) PLPublishingAgent *publishingAgent;
