...
+ (void)considerPlugInClassAtIndex:(unsigned long long)arg1 plugInClasses:(id)arg2 URLComponents:(id)arg3 XPCConnection:(id)arg4 previousPlugInError:(id)arg5 completionHandler:(id /* block */)arg6;
+ (id)dispatchQueue;
