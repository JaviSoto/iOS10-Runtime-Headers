...
@interface AVPlayerViewController : UIViewController <AVPictureInPictureControllerDelegate, UIPopoverPresentationControllerDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate> {
    ...
    struct { 
        ...
        unsigned int playerViewControllerFailedToStartPictureInPicture_withError : 1; 
    ...
    int  _indicatorViewBackgroundColorCounter;
    ...
    AVPictureInPictureIndicatorView * _pictureInPictureIndicatorView;
...
- (void)_hideIndicatorViewBackgroundColorAnimated:(BOOL)arg1;
...
- (void)_showIndicatorViewBackgroundColorAnimated:(BOOL)arg1;
...
- (void)_updateVideoLayerViewAndContentOverlayView;
