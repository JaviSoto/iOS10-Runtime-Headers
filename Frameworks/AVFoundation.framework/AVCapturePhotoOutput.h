...
+ (id)jpegPhotoNSDataRepresentationForSurface:(struct __IOSurface { }*)arg1 size:(unsigned long long)arg2 previewSurface:(struct __IOSurface { }*)arg3 previewSize:(unsigned long long)arg4 metadata:(id)arg5;
...
- (bool)_preparedForPhotoCaptureWithSettings:(id)arg1;
...
- (void)_unprepareWithCompletionHandler:(id /* block */)arg1;
...
- (void)prepareToCapturePhotoWithSettings:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)prepareToCapturePhotoWithSettings:(id)arg1 reclaimResources:(bool)arg2 completionHandler:(id /* block */)arg3;
