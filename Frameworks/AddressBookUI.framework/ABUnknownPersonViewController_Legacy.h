...
@class <ABUnknownPersonViewController_LegacyDelegate>, UIImage, UIFont, ABPersonTableViewSharingDelegate, <ABStyleProvider>, UIView, NSArray, ABUIPerson, ABPersonTableViewDataSource, NSString, ABPersonTableViewActionsDelegate, ABPersonViewControllerHelper;

@interface ABUnknownPersonViewController_Legacy : UIViewController <UIActionSheetDelegate> {
    id _helper;
    <ABUnknownPersonViewController_LegacyDelegate> *_unknownPersonViewDelegate;
    id _reserved;
...
@property <ABUnknownPersonViewController_LegacyDelegate> * unknownPersonViewDelegate;
