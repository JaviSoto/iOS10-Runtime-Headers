...
@class UIImage, AFContextManager, ABPersonViewControllerHelper, <ABPersonViewController_LegacyDelegate>, <ABPersonEditDelegate>, UIFont, ABPersonTableViewSharingDelegate, <ABStyleProvider>, UIView, NSArray, ABUIPerson, ABPersonTableViewDataSource, NSString, ABPersonTableViewActionsDelegate, NSTimer;

@interface ABPersonViewController_Legacy : UIViewController <AFContextProvider, UIViewControllerRestoration> {
    <ABPersonViewController_LegacyDelegate> *_personViewDelegate;
    id _helper;
    id _internal;
    BOOL _internal2;
...
@property <ABPersonViewController_LegacyDelegate> * personViewDelegate;
