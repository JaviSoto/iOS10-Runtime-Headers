...
@interface PUOneUpViewControllerSpec : PUViewControllerSpec {
    ...
    BOOL  _shouldUseCompactComments;
...
@property (nonatomic) BOOL shouldUseCompactComments;
...
- (void)_setShouldUseCompactComments:(BOOL)arg1;
