...
@interface PUOneUpPresentationHelper : NSObject <PUPinchedTileTrackerDelegate, PUTilingViewControllerTransitionEndPoint, PUTilingViewTileSource, PUTilingViewTileTransitionDelegate, PUTilingViewTileUseDelegate, UIGestureRecognizerDelegate> {
...
- (void)_presentOneUpViewController:(id)arg1 animated:(BOOL)arg2 interactiveMode:(int)arg3;
