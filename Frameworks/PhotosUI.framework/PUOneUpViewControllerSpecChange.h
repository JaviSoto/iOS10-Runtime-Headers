...
@interface PUOneUpViewControllerSpecChange : PUViewControllerSpecChange {
    ...
    BOOL  _shouldUseCompactCommentsChanged;
...
@property (nonatomic) BOOL shouldUseCompactCommentsChanged;
...
- (void)_setShouldUseCompactCommentsChanged:(BOOL)arg1;
...
- (BOOL)shouldUseCompactCommentsChanged;
