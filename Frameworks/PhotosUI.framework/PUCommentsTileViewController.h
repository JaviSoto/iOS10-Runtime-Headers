...
@property (setter=_setIsEditingComments:, nonatomic) BOOL _isEditingComments;
...
- (void)_setIsEditingComments:(BOOL)arg1;
...
- (void)_updateTableViewMetricsAnimated:(BOOL)arg1;
