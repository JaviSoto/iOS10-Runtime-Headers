...
+ (void)_showDuplicationWasInterruptedWithItemCount:(long long)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_downloadResourcesForDuplicateAction:(long long)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_performPhotoLibraryChangeForAction:(long long)arg1 completionHandler:(id /* block */)arg2;
...
- (void)performDuplicateAction:(long long)arg1 completionHandler:(id /* block */)arg2;
