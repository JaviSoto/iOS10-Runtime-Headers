...
@class UIViewController<QLPreviewContentControllerProtocol>, UIBarButtonItem, UILabel, NSNumberFormatter, UINavigationController, _UIAsyncInvocation, NSMutableDictionary, NSURL, UIView, MPVolumeView, NSString, QLPreviewItemsSource, UIDocumentInteractionController, <QLPreviewItem>, QLArchiveViewer;
