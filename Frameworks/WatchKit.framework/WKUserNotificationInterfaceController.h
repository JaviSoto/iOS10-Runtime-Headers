...
- (id)init;
- (id)suggestionsForResponseToActionWithIdentifier:(id)arg1 forLocalNotification:(id)arg2;
- (id)suggestionsForResponseToActionWithIdentifier:(id)arg1 forRemoteNotification:(id)arg2;
