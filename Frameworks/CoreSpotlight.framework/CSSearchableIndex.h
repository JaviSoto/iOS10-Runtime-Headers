...
- (void).cxx_destruct;
- (void)_changeStateOfSearchableItemsWithUIDs:(id)arg1 toState:(int)arg2 forUser:(unsigned int)arg3 forBundleID:(id)arg4;
- (id)_checkItems:(id)arg1 clientState:(id)arg2;
- (void)_commonInit;
...
- (void)performMigrationWithTimeout:(double)arg1 completionHandler:(id /* block */)arg2;
- (id)protectionClass;
