...
@interface AUParameterTree : AUParameterGroup <NSSecureCoding> {
    ...
    void * _remoteObserverToken;
    void * _remoteRecorderToken;
...
@property (nonatomic) void*remoteObserverToken;
@property (nonatomic) void*remoteRecorderToken;
...
- (void*)remoteObserverToken;
- (void*)remoteRecorderToken;
...
- (void)setRemoteObserverToken:(void*)arg1;
- (void)setRemoteRecorderToken:(void*)arg1;
