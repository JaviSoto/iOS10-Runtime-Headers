...
@class _UIAsyncInvocation, NSError, MFMailComposePlaceholderViewController, MFMailComposeRemoteViewController, <MFMailComposeViewControllerDelegate>, NSMutableArray, NSString, NSMutableDictionary;
