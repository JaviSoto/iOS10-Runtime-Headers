...
@interface MFMailComposeController : UIViewController <ABPeoplePickerNavigationControllerDelegate, ABPersonViewControllerDelegate, ABUnknownPersonViewControllerDelegate, CNContactViewControllerDelegate, MFComposeActivityContinuationOperationDelegate, MFComposeHeaderViewDelegate, MFComposeImageSizeViewDelegate, MFComposeRecipientTextViewDelegate, MFComposeSubjectViewDelegate, MFComposeTypeFactoryDelegate, MFGroupDetailViewControllerDelegate, MFMailComposeToFieldDelegate, MFMailComposeViewDelegate, MFSecureMIMECompositionManagerDelegate, NSUserActivityDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate> {
